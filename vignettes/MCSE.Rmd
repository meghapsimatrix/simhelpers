...
The equation for the MCSE of RMSE is derived using the jack-knife technique, which involves excluding a replicate $j$ and calculating RMSE. The formula for RMSE is:
