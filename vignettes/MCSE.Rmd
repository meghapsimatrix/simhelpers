...
Below we calculate the rejection rate performance criteria for the hypothesis tests done using t-test. The `calc_rr` function requries a data set or tibble as the first argument. The second argument, `p_values` requires the name of the column containing p-values.  
