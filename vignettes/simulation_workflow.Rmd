...
Below is an example where we generate random normal data for two groups. The function takes in three arguments: `n1`, indicating sample size for Group 1, `n2` indicating sample size for Group 1, and `mean_diff`, indicating the mean difference. 
