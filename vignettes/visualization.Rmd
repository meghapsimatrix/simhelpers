...
Tipton_Pusto %>%
  ...
  labs(x = "Method", y = "Type 1 Error Rate", caption = "FIGURE 2. Type I error for alpha of .05 of five alternative tests. Dashed lines indicate the nominal alpha level") + 
  theme_bw() +
