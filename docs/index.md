...
assist in programming simulations. These include
[`bundle_sim()`](https://meghapsimatrix.github.io/simhelpers/reference/bundle_sim.md),
which can be used to create a single function for running a simulation
from component pieces. The function takes a function for generating
data, a function for analyzing the data, and (optionally) a function for
...
can then be applied to a parameter set using
[`evaluate_by_row()`](https://meghapsimatrix.github.io/simhelpers/reference/evaluate_by_row.md),
which executes the simulation for each combination of conditions
enumerated in the rows of a dataset. This function uses
...
Finally, the package also includes a function
[`create_skeleton()`](https://meghapsimatrix.github.io/simhelpers/reference/create_skeleton.md),
which generates a skeleton outline for a simulation study, and several
...
Here, we present a brief example of using the
[`calc_absolute()`](https://meghapsimatrix.github.io/simhelpers/reference/calc_absolute.md)
function to calculate the bias of an estimator. For demonstration, we
use the `welch_res` dataset included in the package, which contains
...
[`calc_absolute()`](https://meghapsimatrix.github.io/simhelpers/reference/calc_absolute.md)
function to calculate the performance criteria and MCSE. The function
returns a `tibble` containing absolute performance criteria and their
corresponding MCSE.
...
which provided inspiration for our
[`bundle_sim()`](https://meghapsimatrix.github.io/simhelpers/reference/bundle_sim.md)
tools. [`SimDesign`](https://CRAN.R-project.org/package=SimDesign) also
...
parallel computing,
[`evaluate_by_row()`](https://meghapsimatrix.github.io/simhelpers/reference/evaluate_by_row.md)
uses the [`furrr`](https://davisvaughan.github.io/furrr/) and
